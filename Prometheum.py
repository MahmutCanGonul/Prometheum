    ...
    def minus_method(self,other):
        if isinstance(other,Number):
           ...
           try:
               ...
               return None,RunTimeError(other.pos_start,other.pos_end," Element at this index could not be removed from list beacuse index is out of range!",self.context)
    ...
    def divide_method(self,other):
        if isinstance(other,Number):
           ...
           try:
               ...
               return None,RunTimeError(other.pos_start,other.pos_end," Element at this index could not be retrieved from list beacuse index is out of range!",self.context)
